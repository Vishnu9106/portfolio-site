      ...
      <div className="container" style={{ textAlign: 'center' }}>
        <div ref={ref} className={`fade-up ${visible ? 'visible' : ''}`}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem', flexWrap: 'wrap', marginBottom: '5rem' }}>
            <a href="mailto:creativevishnu1999@gmail.com" className="btn btn-white btn-hover-orange">
              <Mail size={18} style={{ marginRight: '8px' }} />
              Gmail
            </a>
            <a href="https://www.linkedin.com/in/vishnudass1/" target="_blank" rel="noreferrer" className="btn btn-white btn-hover-orange">
